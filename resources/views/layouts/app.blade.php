    ...
    <nav class="flex py-5 bg-indigo-500 text-white">
      ...
      @if(auth()->check())
        <li>
          ...
          border-2 border-white py-2 px-4 rounded-md bg-red-500 hover:bg-red-600">
          Log Out</a>
        </li>
      @else
      <li>
          ...
          <a href="{{ route('registeruser.index') }}" class="font-semibold
